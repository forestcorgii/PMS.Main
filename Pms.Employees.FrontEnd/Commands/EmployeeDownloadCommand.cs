...
namespace Pms.Employees.FrontEnd.Commands
{
    public class EmployeeDownloadCommand : IAsyncRelayCommand
    {
        ...
        public EmployeeDownloadCommand(ViewModelBase viewModel, EmployeeStore store, EmployeeModel model)
        {
        ...
        public async Task ExecuteAsync(object? parameter)
        {
            ...
            try
            {
                foreach (string eeId in eeIds)
                {
                    ...
                    IPersonalInformation employeeFoundOnServer = await _model.FindEmployeeAsync(eeId, "MANILA");
